...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "f09d4c8d-f7d9-494c-b9ff-2a29bd022fd5",
# META       "default_lakehouse_name": "LH_Bronze",
# META       "default_lakehouse_workspace_id": "f906e176-d95a-49f4-a2b5-cad4feac1a29",
# META       "known_lakehouses": [
# META         {
# META           "id": "f09d4c8d-f7d9-494c-b9ff-2a29bd022fd5"
# META         }
# META       ]
# META     }
# META   }
...
adls_path = 'abfss://lms-fabric@datalake2198.dfs.core.windows.net/landing' ## (container_name, account_name, relative_path)
...
try:
    spark.read.format('delta').load(fabric_bronze_path).createOrReplaceTempView('bronze_data') # Read data if table already exists
except:                                                                                        # Create table if it DNE
...
# We will take the new_data as the source and the bronze_data as a target and will create an upsert logic to write data from new_data to bronze_data.
